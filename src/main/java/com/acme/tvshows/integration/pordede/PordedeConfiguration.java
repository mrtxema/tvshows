...
@Singleton
@Configured
public class PordedeConfiguration {
    ...
    public String getStoreShowSelect() {
        return storeShowSelect;
    }

    public void setStoreShowSelect(String storeShowSelect) {
        this.storeShowSelect = storeShowSelect;
    }
